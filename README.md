...
Final Summary:
 ...
 [*] Exponent: 25
 [*] Total time: 15.56 seconds
 [*] Speed: 2156742.3 numbers/second
 [*] Numbers processed: 2^25 = 33554431
 [*] Numbers with mr > 1 found: 33554431
 [*] Valid mr validations: 33554431
 [*] Unique mr values discovered: 42
 [*] Percentage with mr > 1: 100.00%
 [*] Violations detected: 0

Final list of mr values:
2, 3, 6, 7, 8, 9, 12, 16, 19, 25, 45, 53, 60, 79, 91, 121, 125, 141, 166, 188, 205, 243, 250, 324, 333, 432, 444, 487, 576, 592, 649, 667, 683, 865, 889, 1153, 1214, 1821, 2428, 3643
...
Note: Values mr = 0 and mr = 1 are excluded from validation as they represent degenerate cases in the tuple-based transform. Specifically:

    mr = 0: Corresponds to sequences that reach the trivial cycle (4 → 2 → 1) without any intermediate repetitions
    mr = 1: Represents immediate convergence cases where the first calculated m value repeats instantly

These cases don't exhibit the complex peak behavior that characterizes meaningful Collatz dynamics and therefore fall outside the scope of theoretical bounds analysis.
...
```c
{2, 4}, {3, 25}, {6, 25}, {7, 79}, {8, 16}, {9, 43}, {12, 43}, {16, 49}, 
